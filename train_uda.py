...
from train import get_default_arguments, create_model, get_cosine_schedule_with_warmup, save_checkpoint, test, \
    log_metrics_to_file, init_run
...
def main():
    ...
    parser.add_argument('--uda', default=True, type=bool)
    parser.set_defaults(T=0.4, threshold=0.8)
